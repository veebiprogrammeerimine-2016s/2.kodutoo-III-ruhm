 <?php
	...
	if (	isset($_POST["firstname"]) &&
		...
		saveNote($_POST["firsname"],$_POST["lastname"],$_POST["notebook"],$_POST["serialnumber"],
	...
	<form method="POST">
		<h2>Arvuti registreerimine remondiks</h2>
			...
			<label><b>Nimi<b></label>
			 <br><input name="fisrtname" type="text"> 
			...
			<select name="notebook" form="notebookform">
			...
			<select name="priority" form="priorityform">
