<?php
	...
	if(isset($_POST["update"])){
		updateNote(cleanInput($_POST["id"]), cleaninput($_POST["note"]), cleanInput($_POST["color"]), cleaninput($_POST["r100"]), cleaninput($_POST["r50"]), cleaninput($_POST["r20"]), cleaninput($_POST["r10"]), cleaninput($_POST["r5"]), cleaninput($_POST["r2"]), cleaninput($_POST["r1"]));
